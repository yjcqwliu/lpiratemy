...
set :application, "lpiratemy"
set :scm, "git"
set :repository,  "git@github.com:yjcqwliu/lpiratemy.git"
set :branch, "master"
set :user, "lpiratemy"
set :use_sudo, false
...
task :after_update_code do 
  ...
  run "cp #{current_release}/config/manyou.yml.production #{current_release}/config/manyou.yml"
end
